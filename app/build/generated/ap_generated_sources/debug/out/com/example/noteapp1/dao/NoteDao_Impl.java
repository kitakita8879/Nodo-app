package com.example.noteapp1.dao;
...
import com.example.noteapp1.entities.Note;
...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `notes` (`id`,`title`,`date_time`,`subtitle`,`note_text`,`image_path`,`color`,`web_link`,`paint_path`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, Note value) {
        ...
        if (value.getPaintPath() == null) {
          stmt.bindNull(9);
        } else {
          stmt.bindString(9, value.getPaintPath());
        }
      }
    };
  ...
  public List<Note> getAllNotes() {
    ...
    try {
      ...
      final int _cursorIndexOfPaintPath = CursorUtil.getColumnIndexOrThrow(_cursor, "paint_path");
      ...
      while(_cursor.moveToNext()) {
        ...
        final String _tmpPaintPath;
        if (_cursor.isNull(_cursorIndexOfPaintPath)) {
          _tmpPaintPath = null;
        } else {
          _tmpPaintPath = _cursor.getString(_cursorIndexOfPaintPath);
        }
        _item.setPaintPath(_tmpPaintPath);
        _result.add(_item);
      }
      return _result;
    } finally {
